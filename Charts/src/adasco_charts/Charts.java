...
public class Charts {
	...
	public static void main(String[] args) throws IOException {
		...
		JFreeChart histogram = ChartFactory.createHistogram("Normal distribution adasco",
		...
		//JOptionPane.showMessageDialog(null, new ImageIcon(histogram));
	}
